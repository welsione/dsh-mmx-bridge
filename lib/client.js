	...
	factory: (require) => {
		...
		function mediaFailHint(el, name) {
			try {
				...
				hint.style.cssText = "font-size:12px;color:var(--dsw-alias-state-error-primary);padding:6px 0;display:flex;align-items:center;gap:6px;width:100%";
...
// mmx_bridge 自定义工具视图：图片缩略图 + 音频/视频内嵌播放器（在当前页面直接播放）
		...
		const css = [
			...
			".mmxb_pillOn{background:var(--dsw-alias-brand-primary);color:var(--dsw-alias-label-primary-foreground)}",
			...
			".mmxb_switchOn::after{transform:translateX(16px);background:var(--dsw-alias-label-primary-foreground)}",
			...
			".mmxb_actionPrimary,.mmxb_actionPrimary:hover{background:var(--dsw-alias-button-primary-fill);border-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}",
			".mmxb_actionPrimary:hover{background:var(--dsw-alias-button-primary-hover);border-color:var(--dsw-alias-button-primary-hover)}",
			...
			".mmxb_envBadgeOff{color:var(--dsw-alias-state-error-primary);border-color:var(--dsw-alias-state-error-primary)}",
			...
			".mmxb_envFootErr{color:var(--dsw-alias-state-error-primary)}",
			".mmxb_failed{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:1.5;margin:8px 0 0}",
