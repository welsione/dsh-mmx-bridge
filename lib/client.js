...
// mmx_bridge 自定义工具视图：图片缩略图 + 音频/视频内嵌播放器（在当前页面直接播放）
		...
		const css = [
			...
			".mmxb_envLine{font-size:11px;line-height:1.5;color:var(--dsw-alias-label-tertiary);margin:8px 0 0;word-break:break-all}",
			".mmxb_envLineErr{color:var(--dsw-alias-label-error)}",
		...
		function MmxSettingsCard() {
			...
			const card = react.createElement("li", { className: "mmxb_card" + (open ? " mmxb_cardOpen" : "") },
				...
				open ? react.createElement("div", { className: "mmxb_body" },
					...
					react.createElement("div", { className: "mmxb_section" },
						react.createElement("h4", { className: "mmxb_sectionTitle" }, "环境（mmx-cli）"),
						react.createElement("div", { className: "mmxb_row" },
							react.createElement("label", { className: "mmxb_rowLabel", htmlFor: "mmxb-mmx-input" }, "mmx 路径"),
						...
						mmxFound
							? react.createElement("p", { className: "mmxb_envLine" }, "✔ 已找到 mmx · " + (mmxPath || "(空)") + (mmxSource ? " · 来源 " + mmxSource : ""))
							: react.createElement("p", { className: "mmxb_envLine mmxb_envLineErr" }, "✖ 未找到 mmx：" + (mmxLookupError || "请配置路径或一键安装")),
						!mmxFound
							? react.createElement("div", { className: "mmxb_row" },
								react.createElement("span", { className: "mmxb_rowText" },
									react.createElement("span", { className: "mmxb_rowLabel" }, "一键安装 mmx-cli"),
									react.createElement("span", { className: "mmxb_rowHint" }, mmxInstall.state === "installing" ? "npm install -g mmx-cli 进行中…" : "未安装时自动执行 npm install -g mmx-cli")
								),
								react.createElement("button", {
									type: "button",
									...
									onClick: installMmx
								}, mmxInstall.state === "installing" ? "安装中…" : "安装 mmx-cli")
							)
							: null,
						(mmxInstall.state === "ok" || mmxInstall.state === "failed")
							? react.createElement("p", { className: "mmxb_envLine" + (mmxInstall.state === "ok" ? "" : " mmxb_envLineErr") }, (mmxInstall.state === "ok" ? "✔ " : "✖ ") + mmxInstall.message)
							: null,
						react.createElement("div", { className: "mmxb_row" },
							react.createElement("label", { className: "mmxb_rowLabel", htmlFor: "mmxb-apikey-input" }, "API Key（登录）"),
							react.createElement("div", { className: "mmxb_envCtl" },
								react.createElement("input", {
								...
								react.createElement("button", {
									type: "button",
									className: "mmxb_action" + (apiKeyDraft.trim() ? " mmxb_actionPrimary" : ""),
						...
						react.createElement("div", { className: "mmxb_row" },
							react.createElement("span", { className: "mmxb_rowText" },
								react.createElement("span", { className: "mmxb_rowLabel" }, "登录状态"),
								react.createElement("span", { className: "mmxb_rowHint" }, (mmxAuth && (mmxAuth.message || mmxAuth.state)) || "未知")
							),
							react.createElement("button", {
								type: "button",
								className: "mmxb_action",
					...
					react.createElement("div", { className: "mmxb_stats", role: "status" },
