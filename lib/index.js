                ...
                disposers.push(ws.register({
                  ...
                  handler: (req, res) => {
                    ...
                    req.on('end', () => {
                      try {
                        const parsed = JSON.parse(body || '{}')
                        const plugin = parsed.plugin === 'websearch' ? 'websearch' : parsed.plugin === 'readimage' ? 'readimage' : parsed.plugin === 'imagebridge' ? 'imagebridge' : parsed.plugin === 'imagecache' ? 'imagecache' : 'vision'
